...
const setupEvents = (data) => {
    ...
    if(data.length) {
        ...
        let html = '';
        let li = `
            <h5 class="left-align">Welcome to Eventi! Meet the next generation of event planning and organization right here at the tips of your fingers.</h5>
            <h5 class="center-align">Eventi was created by developers trying to solve the problem of unorganization and poor planning among different social groups of people. Most important categories of social life are covered in the Eventi planning application. Enjoy!</h5>
